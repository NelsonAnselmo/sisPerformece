...
<div class="row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="form-group d-inline">
            <a href="<?php echo e(URL::action('ConsultorController@relatorio')); ?>" class="btn btn-primary" title="Relatório">
...
<?php /**PATH C:\xampp\htdocs\sisPerformece\resources\views/consultor/search.blade.php ENDPATH**/ ?>